...
class PlaceVisitor : public Visitor{
	...
	public: // visitor methods
		...
		virtual void visit(DeadlockExpression& expr, Result& context);
                ...
                virtual void visit(MultiplyExpression& expr, Result& context){visit((OperationExpression&)expr, context);};
                virtual void visit(SubtractExpression& expr, Result& context){visit((OperationExpression&)expr, context);};;
                virtual void visit(PlusExpression& expr, Result& context){visit((OperationExpression&)expr, context);};;
};
