...
namespace VerifyTAPN
{
	...
	{
	private:
		typedef google::sparse_hash_map<TraceInfo::id_type, TraceInfo, boost::hash<TraceInfo::id_type> > HashMap;
...
//	public:
//		inline void Save(const TraceInfo::id_type& id, const TraceInfo& traceInfo){
//			store.insert(std::pair<TraceInfo::id_type, TraceInfo>(id, traceInfo));
//		};
