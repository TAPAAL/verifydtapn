...
namespace VerifyTAPN {
    namespace DiscreteVerification {
        ...
        bool ReducingGenerator::ample_set(const TAPN::TimedPlace *inv_place, const TAPN::TimedTransition *trans) {
            ...
            interesting.clear();
            _query->accept(interesting, context);
        ...
        bool ReducingGenerator::compute_closure(bool added_zt) {
            ...
            while (!_unprocessed.empty()) {
                ...
                if (_enabled[tr]) {
                    ...
                    if (auto inhib = _transition_iterator.is_inhibited(trans)) {
                        ...
                        auto place = _transition_iterator.compute_missing(trans, nullptr);
                        bool found = false;
