...
void Verification::PrintHumanTrace(NonStrictMarking* m, std::stack<NonStrictMarking*>& stack, AST::Quantifier query) {
...
void Verification::PrintXMLTrace(NonStrictMarking* m, std::stack<NonStrictMarking*>& stack, AST::Quantifier query) {
...
rapidxml::xml_node<>* Verification::CreateTransitionNode(NonStrictMarking* old, NonStrictMarking* current, rapidxml::xml_document<>& doc){
	using namespace rapidxml;
...
void Verification::createTransitionSubNodes(NonStrictMarking* old, NonStrictMarking* current, rapidxml::xml_document<>& doc, rapidxml::xml_node<>* transitionNode, const TAPN::TimedPlace& place, const TAPN::TimeInterval& interval, const int weight){
...
rapidxml::xml_node<>* Verification::createTokenNode(rapidxml::xml_document<>& doc, const TAPN::TimedPlace& place, const Token& token){
	using namespace rapidxml;
...
void Verification::GenerateTraceStack(NonStrictMarking* m, std::stack<NonStrictMarking*>* result ,std::stack<NonStrictMarking*>* liveness) {
	if(liveness == NULL) {
