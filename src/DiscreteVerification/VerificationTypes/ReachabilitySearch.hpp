...
public:
    ...
    {
        pwList = new PWListHybrid(tapn, waiting_list, options.getKBound(), tapn->NumberOfPlaces(), tapn->MaxConstant(), false, options.getTrace() == VerificationOptions::SOME_TRACE);
    };
